        ...
        try {
            ...
            for (int i = 0; i < jRoutes.length(); i++) {
                ...
                //
                 ...
                 getdt.Distance=jsonDistance.getInt("value");
                 getdt.Timeuse=jsonDuration.getString("text");
                 getdt.startLocation=new LatLng(jsonStartLocation.getDouble("lat"), jsonStartLocation.getDouble("lng"));
                 getdt.endLocation=new LatLng(jsonEndLocation.getDouble("lat"), jsonEndLocation.getDouble("lng"));
