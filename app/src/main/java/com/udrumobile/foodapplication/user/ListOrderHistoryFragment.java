...
import com.udrumobile.foodapplication.user.adapter_user.OrderAdapterHistory;
...
public class ListOrderHistoryFragment extends Fragment {
    ...
    public ListOrderHistoryFragment() {
        // Required empty public constructor
    }


    public static ListOrderHistoryFragment newInstance(String param1, String param2) {
        ListOrderHistoryFragment fragment = new ListOrderHistoryFragment();
    ...
    public static class DownloadJSON extends AsyncTask<Void, Void, Void> {
        int status;
        String FOODRES_URL = getdt.SetIP+"/LoginServer/listorderHistory.php?user_id="+getdt.IDUser;
        ...
        protected void onPostExecute(Void args) {
            ...
            OrderAdapterHistory adapter = new OrderAdapterHistory(context, order_id, namefood, food_status, img, qty, price, date);
