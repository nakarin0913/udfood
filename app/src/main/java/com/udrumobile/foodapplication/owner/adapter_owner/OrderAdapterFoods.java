...
public class OrderAdapterFoods extends BaseAdapter {
    Context mContext;
    ...
    ListOrderFoodFragment listOrderFoodFragment=new ListOrderFoodFragment();

    Getdata getdt = new Getdata();


    public OrderAdapterFoods(Context context, ArrayList<Integer> order_id, ArrayList<String> name, ArrayList<String> status, ArrayList<String> img, ArrayList<String> qty, ArrayList<String> price, ArrayList<String> date,ArrayList<String> fullname) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            view = mInflater.inflate(R.layout.listview_order_foods, parent, false);
        }
...
//                    getdt.Order_ID= listOrderFoodFragment.order_id.get(position);
                Log.e("ORDER_ID.GET",listOrderFoodFragment.order_id.get(position).toString());
        ...
        txt_fullname.setText(fullname.get(position));
